...
|--------|--------------------|---------------------|---------------|
| **Security / vulnerability audit** | AuditScan (`HappyMonkeyAI/AuditScan`) | CLI and/or MCP; register in proxy if missing | Trident **input**, not Owner V2/V3 substitute |
| **Article / tutorial research** | `article-research-mcp` | MonkeySwarm `research` profile; proxy search “article research” | Planning / Deep Mode RECON |
| Social / trend research | `social-research-mcp` | research profile | Content planning |
